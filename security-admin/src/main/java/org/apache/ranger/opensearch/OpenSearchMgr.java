...
import static org.apache.ranger.audit.destination.OpenSearchAuditDestination.CONFIG_INDEX;
import static org.apache.ranger.audit.destination.OpenSearchAuditDestination.CONFIG_PORT;
import static org.apache.ranger.audit.destination.OpenSearchAuditDestination.CONFIG_PREFIX;
import static org.apache.ranger.audit.destination.OpenSearchAuditDestination.CONFIG_PROTOCOL;
import static org.apache.ranger.audit.destination.OpenSearchAuditDestination.CONFIG_PWRD;
import static org.apache.ranger.audit.destination.OpenSearchAuditDestination.CONFIG_URLS;
import static org.apache.ranger.audit.destination.OpenSearchAuditDestination.CONFIG_USER;
...
public class OpenSearchMgr {
    ...
    public static RestClientBuilder getRestClientBuilder(String urls, String protocol, String user, String password, int port) {
        ...
        if (StringUtils.isNotBlank(user) && StringUtils.isNotBlank(password) && !user.equalsIgnoreCase("NONE") && !password.equalsIgnoreCase("NONE")) {
            ...
            logger.error("OpenSearch Credentials not provided!!");
