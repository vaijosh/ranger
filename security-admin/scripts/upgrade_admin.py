...
config2xmlMAP = {
	...
	'audit_opensearch_urls':'ranger.audit.opensearch.urls',
	'audit_opensearch_protocol':'ranger.audit.opensearch.protocol',
	'audit_opensearch_port':'ranger.audit.opensearch.port',
	'audit_opensearch_user':'ranger.audit.opensearch.user',
	'audit_opensearch_password':'ranger.audit.opensearch.password',
